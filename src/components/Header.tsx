...
export default function Header() {
    return (
        <HStack justifyContent={"space-between"} w="100%" h={14} bg="gray.400" borderBottom={"1px solid rgba(0,0,0,0.4)"}>
            <Flex alignItems={"center"}>
                ...
                <HStack mt={2} ml={24} w={52} h="12" bgColor={"gray.300"} borderTopRadius={20}>
                ...
                <HStack mt={2} ml={3} w={52} h="12" bgColor={"gray.300"} borderTopRadius={20}>
                    ...
                    <Text ml={4} fontSize={20} fontWeight={"500"} color="black">Project</Text>
                </HStack>
                <HStack mt={2} ml={3} w={52} h="12" bgColor={"gray.300"} borderTopRadius={20}>
